...
class ArticalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artical" do
    assert_difference('Artical.count') do
      post articals_url, params: { artical: { body: @artical.body, title: @artical.title, user_id: @artical.user_id } }
    end
  ...
  test "should update artical" do
    patch artical_url(@artical), params: { artical: { body: @artical.body, title: @artical.title, user_id: @artical.user_id } }
