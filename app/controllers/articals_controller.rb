class ArticalsController < ApplicationController
  ...
  def new
    if session[:user].nil?
      ...
      @artical = Artical.new
      @artical.user_id = session[:user].to_i
    end
  end
  ...
  def create
    ...
    respond_to do |format|
      if @artical.save
        format.html { redirect_to @artical, success: 'Artical was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @artical.update(artical_params)
        format.html { redirect_to @artical, success: 'Artical was successfully updated.' }
  ...
  def destroy
    @artical.destroy
    respond_to do |format|
      format.html { redirect_to articals_url, success: 'Artical was successfully destroyed.' }
  ...
  private
    ...
    def artical_params
      params.require(:artical).permit(:title, :body, :user_id)
    end
end
